''' Made the board using dictionary 
    in which keys will be the location e.g bottom left
    and initialliy it's values will be empty space,
    then after every move change the value according to user's choice of move. '''
...
''' Print the updated board after every move in the game and 
