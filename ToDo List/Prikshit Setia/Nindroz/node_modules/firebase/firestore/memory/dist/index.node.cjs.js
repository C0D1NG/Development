...
function E$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.DEBUG) {
        var i = e.map(A$1);
        w$1.debug.apply(w$1, __spreadArrays([ "Firestore (7.19.1): " + t ], i));
    }
}
...
function I$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.ERROR) {
        var i = e.map(A$1);
        w$1.error.apply(w$1, __spreadArrays([ "Firestore (7.19.1): " + t ], i));
    }
}
...
function N$1(t) {
    ...
    if (w$1.logLevel <= LogLevel.WARN) {
        var i = e.map(A$1);
        w$1.warn.apply(w$1, __spreadArrays([ "Firestore (7.19.1): " + t ], i));
    }
}
...
}(G$1), z = /^[_a-zA-Z][_a-zA-Z0-9]*$/, W$1 = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n.prototype.V = function(t, e, r) {
...
function K$1(t) {
    ...
    if (null === e.K) {
        ...
        n += Ln(e.startAt)), e.endAt && (n += "|ub:", n += Ln(e.endAt)), e.K = n;
    }
    return e.K;
}
...
function J$1(t) {
    return $.j(t.path) && null === t.collectionGroup && 0 === t.filters.length;
}
 ...
 */ var It = /** @class */ function() {
    ...
    function t(t) {
        ...
        this.P = t ? function(e, n) {
            return t(e, n) || $.P(e.key, n.key);
        } : function(t, e) {
            return $.P(t.key, e.key);
    ...
    return t.Wt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Ut === t.Ut && this.qt.isEqual(t.qt) && gn(this.query, t.query) && this.docs.isEqual(t.docs) && this.Mt.isEqual(t.Mt))) return !1;
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.Ve = function(t) {
        for (var e = 0, n = t.te; e < n.length; e++) {
            var r = n[e];
            t.ee instanceof on ? this.ye(r, t.ee) : t.ee instanceof sn && this.pe(r, t.key, t.ee);
        }
        ...
        this.Ie.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Yt && J$1(o.target)) {
                    ...
                    var s = new $(o.target.path);
                    null !== e.Re.get(s) || e.ke(i, s) || e.pe(i, s, new sn(s, t));
                }
...
function Gt(t) {
    return function t(e) {
        ...
        $.B(r).toString()) : "geoPointValue" in e ? "geo(" + (n = e.geoPointValue).latitude + "," + n.longitude + ")" : "arrayValue" in e ? function(e) {
...
function he(t, e) {
    ...
    new $((k$1((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
 ...
 * limitations under the License.
 */
/** Represents a transform within a TransformMutation. */ var Ne = function() {
 ...
 */ function Ae(t, e, n) {
    ...
    }(n, e) : t instanceof De ? _e(t, e) : t instanceof Ve ? Se(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = ke(t, e), r = Pe(n) + Pe(t.Ue);
        return Qt(n) && Qt(t.Ue) ? ee(r) : ne(t.serializer, r);
    }(t, e);
}
 ...
 */ function Te(t, e, n) {
    ...
    // applications.
    return t instanceof De ? _e(t, e) : t instanceof Ve ? Se(t, e) : n;
}
...
/** Transforms a value into a server-generated timestamp. */ var Re = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return __extends(n, e), n;
}(Ne), De = /** @class */ function(e) {
    function n(t) {
        var n = this;
...
/** The result of successfully applying a mutation to the backend. */ var Ce = function(
/**
 ...
 */ function je(t, e, n) {
    return t instanceof $e ? function(t, e, n) {
        ...
        if (k$1(null != n.transformResults), !Fe(t.We, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */
        function(t, e, n) {
            ...
            for (var i = 0; i < n.length; i++) {
                ...
                e instanceof on && (u = e.field(o.field)), r.push(Te(s, u, n[i]));
            }
            return r;
    ...
    return t instanceof $e ? function(t, e) {
        ...
        var i = Ye(t, e), o = function(t, e, n, r) {
            for (var i = [], o = 0, s = t; o < s.length; o++) {
                ...
                c = r.field(u.field)), i.push(Ae(a, c, e));
            }
            return i;
        ...
        return Fe(t.We, e) ? new sn(t.key, j.min()) : e;
    }(t, e);
}
 ...
 */ function Be(t, e) {
    return t instanceof He ? function(t, e) {
        for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
            var o = i[r], s = e instanceof on ? e.field(o.field) : void 0, u = ke(o.transform, s || null);
            null != u && (n = null == n ? (new en).set(o.field, u) : n.set(o.field, u));
        }
        return n ? n.ze() : null;
    }(t, e) : null;
}
    ...
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.We.isEqual(e.We) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.qe.isEqual(e.qe) : 2 /* Transform */ !== t.type || S$1(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof De && e instanceof De || t instanceof Ve && e instanceof Ve ? S$1(t.elements, e.elements, Mt) : t instanceof Le && e instanceof Le ? Mt(t.Ue, e.Ue) : t instanceof Re && e instanceof Re;
 ...
 */ function We(t) {
    return t instanceof on ? t.version : j.min();
}

/**
 * A mutation that creates or replaces the document at the given key with the
 * object value contents.
 */ var $e = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
...
function Xe(t, e) {
    ...
    }(t, e instanceof on ? e.data() : tn.empty());
}
...
function Ke(t, e, n) {
    for (var r = new en(e), i = 0; i < t.fieldTransforms.length; i++) {
...
/** A mutation that deletes the document at the given key. */ var Ze = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 */ var cn = /** @class */ function() {
     ...
     */    return t.prototype.on = function(e) {
        ...
        return !Q$1(this.limit) && "F" /* First */ === this.nn;
    }, t.prototype.un = function() {
        return !Q$1(this.limit) && "L" /* Last */ === this.nn;
 ...
 */ function ln(t) {
    ...
    if (null === e.sn) {
        ...
        n.L() || e.sn.push(new Un(n)), e.sn.push(new Un(W$1.M(), "asc" /* ASCENDING */)); else {
 ...
 */ function pn(t) {
    var e = an(t, cn);
    if (!e.rn) if ("F" /* First */ === e.nn) e.rn = Y$1(e.path, e.collectionGroup, ln(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // Now return as a LimitType.First query.
                e.rn = Y$1(e.path, e.collectionGroup, n, e.filters, e.limit, u, a);
    }
    return e.rn;
}

function dn(t, e, n) {
    return new cn(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), e, n, t.startAt, t.endAt);
}

function yn(t, e) {
    return new cn(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), t.limit, t.nn, e, t.endAt);
}

function vn(t, e) {
    return new cn(t.path, t.collectionGroup, t.en.slice(), t.filters.slice(), t.limit, t.nn, t.startAt, e);
}

function gn(t, e) {
    return Z$1(pn(t), pn(e)) && t.nn === e.nn;
}
...
function wn(t) {
    return "Query(target=" + function(t) {
        ...
        Q$1(t.limit) || (e += ", limit: " + t.limit), t.orderBy.length > 0 && (e += ", orderBy: [" + t.orderBy.map((function(t) {
            return (e = t).field.N() + " (" + e.dir + ")";
            var e;
        })).join(", ") + "]"), t.startAt && (e += ", startAt: " + Ln(t.startAt)), t.endAt && (e += ", endAt: " + Ln(t.endAt)), 
        "Target(" + e + ")";
    }(pn(t)) + "; limitType=" + t.nn + ")";
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function bn(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.W(t.collectionGroup) && t.path.C(n) : $.j(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
...
var In = /** @class */ function(e) {
     ...
     */    return __extends(n, e), n.create = function(t, e, r) {
        if (t.L()) return "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.dn(t, e, r) : new Nn(t, e, r);
        if (Ht(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Rn(t, r) : "in" /* IN */ === e ? new Dn(t, r) : "not-in" /* NOT_IN */ === e ? new _n(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new Vn(t, r) : new n(t, e, r);
    }, n.dn = function(t, e, n) {
        return "in" /* IN */ === e ? new An(t, n) : new Tn(t, n);
...
var Nn = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, t, n, r) || this).key = $.B(r.referenceValue), i;
    }
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = $.P(t.key, this.key);
        return this.wn(e);
    }, n;
}(In), An = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
/** A Filter that implements the array-contains operator. */ var Rn = /** @class */ function(e) {
    ...
    return __extends(n, e), n.prototype.matches = function(t) {
        var e = t.field(this.field);
        return Xt(e) && Ft(e.arrayValue, this.value);
    }, n;
...
/** A Filter that implements the IN operator. */ function Ln(t) {
 ...
 */ function Pn(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.L() ? $.P($.B(s.referenceValue), n.key) : xt(s, n.field(o.field)), 
...
function qn(t, e, n) {
    var r = t.field.L() ? $.P(e.key, n.key) : function(t, e, n) {
 ...
 */ var Mn = /** @class */ function() {
    ...
    t.prototype.In = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Ge(i, e, e, this.mn));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = Ge(a, e, o, this.mn));
        }
        return e;
    }, 
    /**
 ...
 */
        return function(t) {
            return $.j(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.jn(t, e.path) : fn(e) ? this.Gn(t, e, n) : this.Kn(t, e, n);
    }, t.prototype.jn = function(t, e) {
        // Just do a simple document lookup.
        return this.On(t, new $(e)).next((function(t) {
            var e = vt();
            return t instanceof on && (e = e.st(t.key, t)), e;
        }));
    }, t.prototype.Gn = function(t, e, n) {
        var r = this, i = e.collectionGroup, o = vt();
        return this.kn.zn(t, i).next((function(s) {
            return xn.forEach(s, (function(s) {
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Yn(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = Ge(a, h, h, o.mn);
                    r = f instanceof on ? r.st(c, f) : r.remove(c);
                }
            }));
        })).next((function() {
        ...
        return this.Nn.getEntries(t, r).next((function(t) {
            return t.forEach((function(t, e) {
                null !== e && e instanceof on && (c = c.st(t, e));
            })), c;
        }));
    }, t;
}(), Gn = /** @class */ function() {
...
/** The result of applying a mutation batch to the backend. */ Bn.rs = -1;
 ...
 * limitations under the License.
 */
/** The Platform's 'document' implementation or null if not available. */ function Qn() {
 ...
 */ var Xn = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.Rs = t, this.hs = e, this.As = n, this.op = r, this.Ps = i, this.Vs = new zn, 
    ...
    function t() {
        ...
        this.ks = new Wn(this, "async_queue_retry" /* AsyncQueueRetry */), 
 ...
 */
    ...
    t.prototype.Ts = function(t, e, n) {
        ...
        var i = Xn.ys(this, t, e, n, (function(t) {
            return r.Qs(t);
        }));
 ...
 */
function Yn(t, e) {
    if (I$1("AsyncQueue", e + ": " + t), $n(t)) return new F$1(M$1.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
Kn.ni = -1, Kn.si = 1048576, Kn.ii = 41943040, Kn.ti = 10, Kn.ei = 1e3, Kn.ri = new Kn(Kn.ii, Kn.ti, Kn.ei), 
Kn.oi = new Kn(Kn.ni, 0, 0);
...
var Zn = /** @class */ function() {
    ...
    return t.prototype.ai = function(t, e) {
        return this.hi.add(e), xn.resolve();
    }, t.prototype.zn = function(t, e) {
        return xn.resolve(this.hi.getEntries(e));
    }, t;
}(), Jn = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.wi = j.min(), this.$n = t.mi(n), this.Ti = t.Ei(), this.Ii = t.Ri(), this.Ai = new jn(this.Ti, this.$n, this.persistence.Pi()), 
        this._i.Vi(this.Ai);
    }
...
function nr(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = xn.resolve();
     ...
     */
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Gt.forEach((function(a, c) {
                ...
                // cache.
                                c instanceof sn && c.version.isEqual(j.min()) ? (
 ...
 */ function ur(t, e, n) {
     ...
     */
        ...
        return function(t, e, n) {
            ...
            return void 0 !== i ? xn.resolve(r.fi.get(i)) : r.Ii.Ui(e, n);
 ...
 */ var cr = /** @class */ function() {
    function t() {
        ...
        this.Qi = new ht(hr.ji), 
        // A set of outstanding references to a document sorted by target id.
        this.Gi = new ht(hr.Ki)
    ...
    t.prototype.Zi = function(t) {
        var e = this, n = new $(new B([])), r = new hr(n, t), i = new hr(n, t + 1), o = [];
        ...
        var e = new $(new B([])), n = new hr(e, t), r = new hr(e, t + 1), i = wt();
        return this.Gi.St([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.nr = function(t) {
        var e = new hr(t, 0), n = this.Qi.Dt(e);
    ...
    return t.ji = function(t, e) {
        return $.P(t.key, e.key) || V$1(t.sr, e.sr);
    }, 
    /** Compare by ID then by key */ t.Ki = function(t, e) {
        return V$1(t.sr, e.sr) || $.P(t.key, e.key);
    }, t;
}(), fr = /** @class */ function() {
    function t(t) {
        this.uid = t;
...
fr.or = new fr("google-credentials-uid"), fr.hr = new fr("first-party-uid");
...
var lr = function(t, e) {
    ...
    function t(t) {
        ...
        this.currentUser = fr.UNAUTHENTICATED, this.wr = !1, 
        /**
    ...
    return t.prototype.getToken = function() {
        ...
        // request is outstanding.
            ...
            t.getToken()) : n ? (k$1("string" == typeof n.accessToken), new lr(n.accessToken, t.currentUser)) : null;
    ...
    t.prototype.Tr = function() {
        ...
        return k$1(null === t || "string" == typeof t), new fr(t);
    }, t;
}(), yr = /** @class */ function() {
    function t(t, e) {
        this.Er = t, this.Ir = e, this.type = "FirstParty", this.user = fr.hr;
    }
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new yr(this.Er, this.Ir));
    }, t.prototype.lr = function(t) {
    ...
    function t(t, e, n, r, i, o) {
        ...
        /**
             ...
             * close.
             */
        this.yr = 0, this.pr = null, this.stream = null, this.ks = new Wn(t, e)
        /**
    ...
    return __extends(n, e), n.prototype.Mr = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var c = he(t, a.document.name), h = ue(a.document.updateTime), f = new tn({
                    mapValue: {
                ...
                y.document;
                var v = he(t, y.document), g = y.readTime ? ue(y.readTime) : j.min(), m = new sn(v, g), w = y.removedTargetIds || [];
                n = new Rt([], w, m.key, m);
    ...
    r, i, o, s) {
        ...
        this.Ao = function(t, e, n) {
            var r = R$1(t);
            return r.Xr(), new mr(e, r.Pr, r.credentials, r.serializer, n);
        }(this.lo, i, {
            ...
            var r = R$1(t);
            return r.Xr(), new wr(e, r.Pr, r.credentials, r.serializer, n);
        }(this.lo, i, {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 7:
                    return n.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , rr(this.co) ];
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 2:
                    return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , or(this.co, t) ];
    ...
    t.prototype.zo = function(t) {
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return e = this._o.shift(), i = Fn.from(e, t, r), [ 4 /*yield*/ , this.Qo((function() {
                        return o.qo.Xo(i);
                    })) ];
    ...
    function t() {
        this.oh = new Nr, this.hh = {}, this.eo = null, this.ts = null;
    }
    return t.prototype.ah = function(t) {
        ...
        return this.oh = new Nr, Promise.resolve();
    ...
    e) {
        ...
        this.qt = wt(), this.Vh = En(t), this.yh = new It(this.Vh);
    }
...
n) {
    ...
    r, i, o) {
        ...
        /**
             ...
             */
        this.Kh = new Map, this.zh = new cr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Hh = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Yh = new Map, this.Jh = tr.li(), this.onlineState = "Unknown" /* Unknown */ , 
                    ...
                    function(t, e) {
                        ...
                        return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
                            ...
                            return n.Ii.Ui(t, e).next((function(i) {
                                ...
                                r = i, xn.resolve(r)) : n.Ii.ea(t).next((function(i) {
    ...
    t.prototype.sa = function(t, r, i) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return [ 4 /*yield*/ , ur(this.co, t, 
                    /* usePreviousResults= */ !0) ];

                  case 1:
                    return e = n.sent(), o = new Rr(t, e.Wi), s = o.gh(e.documents), u = kt.Ht(r, i && "Offline" /* Offline */ !== this.onlineState), 
                    a = o.Ch(s, 
                    /* updateLimboDocuments= */ this.Zh, u), this.ia(r, a.Nh), c = new Dr(t, r, o), 
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    this.qh.fh(e.targetId), this.qh.Th(e.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , sr(this.co, e.targetId, 
                  ...
                  case 3:
                    return this.ra(e.targetId), [ 4 /*yield*/ , sr(this.co, e.targetId, 
                        ...
                        return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                            return r.Ai.Un(t, o).next((function(o) {
                                ...
                                var s = [], u = 0, a = e; u < a.length; u++) {
                                    ...
                                    // exists=true
                                    s.push(new Qe(c.key, h, nn(h.proto.mapValue), Me.exists(!0)));
                                }
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , ir(this.co, t) ];
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.qh._h(t, "rejected", r), e = this.Kh.get(t), (i = e && e.key) ? (o = (o = new ut($.P)).st(i, new sn(i, j.min())), 
    ...
    t.prototype._a = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Tr ? (this.zh.zi(i.key, t), this.Ra(i)) : i instanceof kr ? (E$1("SyncEngine", "Document no longer in limbo: " + i.key), 
    ...
    t.prototype.la = function() {
        for (;this.jh.length > 0 && this.Gh.size < this.Uh; ) {
            ...
            this.Kh.set(e, new _r(t)), this.Gh = this.Gh.st(t, e), this.Mh.listen(new rt(pn(hn(t.path)), e, 2 /* LimboResolution */ , Bn.rs));
        }
    }, 
    // Visible for testing
                    ...
                    return i = [], o = [], s = [], this.Wh.forEach((function(e, n) {
                        s.push(Promise.resolve().then((function() {
                            ...
                            if (u.ia(n.targetId, s.Nh), s.snapshot) {
                                ...
                                var a = Gn.Zn(n.targetId, s.snapshot);
                                o.push(a);
                            }
                        })));
                                ...
                                switch (n.label) {
                                  ...
                                  case 1:
                                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , e.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                        return xn.forEach(r, (function(n) {
                                            return xn.forEach(n.Jn, (function(r) {
                                                return e.persistence.Li.zi(t, n.targetId, r);
                                            })).next((function() {
                                                return xn.forEach(n.Xn, (function(r) {
                                  ...
                                  case 0:
                                    return e = R$1(t), i = e.$n, o = e.Ai, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                                        ...
                                        return e.$n.Va(t).next((function(s) {
                                            ...
                                            // MutationQueue.
                                            o = new jn(e.Ti, i, e.persistence.Pi()), i.Va(t);
                                        })).next((function(e) {
    ...
    function t(t) {
        this.qo = t, this.ba = new C$1((function(t) {
            return mn(t);
        }), gn), this.onlineState = "Unknown" /* Unknown */ , this.Sa = new Set, this.qo.subscribe(this);
    }
    return t.prototype.listen = function(t) {
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (e = t.query, r = !1, (i = this.ba.get(e)) || (r = !0, i = new Sr), !r) return [ 3 /*break*/ , 4 ];
                    n.label = 1;
                  ...
                  case 3:
                    return s = n.sent(), u = Yn(s, "Initialization of query '" + wn(t.query) + "' failed"), 
    ...
    return t.prototype.Vi = function(t) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var u = i.Wa(e, o);
            return (e.an() || e.un()) && i.Sh(e.nn, u, r, n) ? i.Ba(t, e) : (b() <= LogLevel.DEBUG && E$1("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), wn(e)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Wa = function(t, e) {
        ...
        return e.forEach((function(e, r) {
            r instanceof on && bn(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
    ...
    t.prototype.Sh = function(t, e, n, r) {
        ...
        return b() <= LogLevel.DEBUG && E$1("IndexFreeQueryEngine", "Using full collection scan to execute query:", wn(e)), 
    ...
    function t(t, e) {
        ...
        this.ja = new ht(hr.ji);
    }
    return t.prototype.Ga = function(t) {
        return xn.resolve(0 === this.$n.length);
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.ja = this.ja.add(new hr(a.key, i)), this.kn.ai(t, a.key.path.g());
        }
        return xn.resolve(o);
    }, t.prototype.da = function(t, e) {
        return xn.resolve(this.Ka(e));
    }, t.prototype.qi = function(t, e) {
        var n = e + 1, r = this.za(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return xn.resolve(this.$n.length > i ? this.$n[i] : null);
    }, t.prototype.ma = function() {
        return xn.resolve(0 === this.$n.length ? -1 : this.Qa - 1);
    }, t.prototype.Va = function(t) {
        return xn.resolve(this.$n.slice());
    }, t.prototype.xn = function(t, e) {
        var n = this, r = new hr(e, 0), i = new hr(e, Number.POSITIVE_INFINITY), o = [];
        ...
        return e.forEach((function(t) {
            var e = new hr(t, 0), i = new hr(t, Number.POSITIVE_INFINITY);
            n.ja.St([ e, i ], (function(t) {
                r = r.add(t.sr);
            }));
        })), xn.resolve(this.Ha(r));
        ...
        // because it precedes all other segments in an ordered traversal.
                $.j(i) || (i = i.child(""));
        var o = new hr(new $(i), 0), s = new ht(V$1);
        ...
        var r = this.ja;
        return xn.forEach(e.mutations, (function(i) {
            var o = new hr(i.key, e.batchId);
        ...
        var n = new hr(e, 0), r = this.ja.Dt(n);
        return xn.resolve(e.isEqual(r && r.key));
    }, t.prototype.Ci = function(t) {
        return this.$n.length, xn.resolve();
    }, 
    /**
    ...
    t.prototype.Oi = function(t) {
        ...
        for (var r = vt(), i = new $(e.path.child("")), o = this.docs.ct(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.Tt(); ) {
            var s = o.wt(), u = s.key, a = s.value, c = a.tu, h = a.readTime;
            if (!e.path.C(u.path)) break;
            h.o(n) <= 0 || c instanceof on && bn(e, c) && (r = r.st(c.key, c));
        }
        return xn.resolve(r);
    }, t.prototype.eu = function(t, e) {
        return xn.forEach(this.docs, (function(t) {
            return e(t);
        }));
...
qr.nu = /** @class */ function(e) {
    ...
    t.prototype.Mn = function(t, e) {
        this.ou();
        var n = this.ha.get(e);
        return void 0 !== n ? xn.resolve(n) : this.hu(t, e);
    }, 
    /**
...
var Cr = /** @class */ function() {
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this._u = new cr, this.targetCount = 0, this.fu = tr.ci();
    }
    return t.prototype.ve = function(t, e) {
        ...
        return xn.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.du = function(t) {
        return xn.resolve(this.lu);
    }, t.prototype.ea = function(t) {
        return this.highestTargetId = this.fu.next(), xn.resolve(this.highestTargetId);
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.fu = new tr(e), this.highestTargetId = e), t.sequenceNumber > this.lu && (this.lu = t.sequenceNumber);
    }, t.prototype.na = function(t, e) {
        return this.wu(e), this.targetCount += 1, xn.resolve();
    }, t.prototype.ki = function(t, e) {
        return this.wu(e), xn.resolve();
        ...
        return this._u.Zi(e), xn.resolve();
    }, t.prototype.Bi = function(t, e) {
        var n = this._u.er(e);
        return xn.resolve(n);
    }, t.prototype.nr = function(t, e) {
        return xn.resolve(this._u.nr(e));
    }, t;
}(), Mr = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.Ru = {}, this.Au = new Bn(0), this.Pu = !1, this.Pu = !0, this.Li = t(this), 
        this.Ii = new Cr(this), this.kn = new Zn, this.Nn = new qr(this.kn, (function(t) {
            return e.Li.Vu(t);
        }));
    }
    return t.prototype.start = function() {
        ...
        var e = this.Ru[t.rr()];
        return e || (e = new Ur(this.kn, this.Li), this.Ru[t.rr()] = e), e;
        ...
        return xn.Fn(Object.values(this.Ru).map((function(n) {
            return function() {
                return n.nr(t, e);
            };
        })));
    ...
    return t.ku = function(e) {
        ...
        return this.Nu.zi(n, e), this.Ou.delete(n.toString()), xn.resolve();
    }, t.prototype.Yi = function(t, e, n) {
        return this.Nu.Yi(n, e), this.Ou.add(n.toString()), xn.resolve();
    }, t.prototype.Ja = function(t, e) {
        return this.Ou.add(e.toString()), xn.resolve();
        ...
        // Remove newly orphaned documents.
                return xn.forEach(this.Ou, (function(r) {
            var i = $.U(r);
        ...
        var n = this;
        return xn.Fn([ function() {
            return xn.resolve(n.Nu.nr(e));
        }, function() {
    ...
    return __extends(n, e), n.prototype.Ju = function(t, e, n, r) {
        ...
        var s = r.createWebChannel(o, i), p = !1, d = !1, y = new jr({
            Lu: function(t) {
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Qr = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Xr = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t) {
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new Or, r = t.cc, new er(e, n, r);
        var e, n, r;
    }, t.prototype.oc = function(t) {
        if (t._c.lc) throw new F$1(M$1.FAILED_PRECONDITION, Qr);
        return new Mr(xr.ku);
    ...
    return t.prototype.initialize = function(t, r) {
        ...
        return new Lr(this.qo);
    }, t.prototype.fc = function(t) {
        var e, n = $r(t.Gu.s), r = (e = t.Gu, new Br(e));
        /** Return the Platform-specific connectivity monitor. */ return function(t, e, n) {
            return new br(t, e, n);
        }(t.credentials, r, n);
    }, t.prototype.dc = function(t) {
        var e = this;
        return new Ir(this.co, this.lo, t.Rs, (function(t) {
 ...
 */ function Zr(t, e) {
    if (0 !== e.length) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() does not support arguments, but was called with " + vi(e.length, "argument") + ".");
}
 ...
 */ function Jr(t, e, n) {
    if (e.length !== n) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires " + vi(n, "argument") + ", but was called with " + vi(e.length, "argument") + ".");
}
 ...
 */ function ti(t, e, n) {
    if (e.length < n) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires at least " + vi(n, "argument") + ", but was called with " + vi(e.length, "argument") + ".");
}
 ...
 */ function ei(t, e, n, r) {
    if (e.length < n || e.length > r) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires between " + n + " and " + r + " arguments, but was called with " + vi(e.length, "argument") + ".");
}
 ...
 */ function ui(t, e, n, r) {
    if (!e.some((function(t) {
        return t === r;
    }))) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid value " + hi(r) + " provided to function " + t + "() for its " + yi(n) + " argument. Acceptable values: " + e.join(", "));
    return r;
}

/** Helper to validate the type of a provided input. */ function ai(t, e, n, r) {
    if (!("object" === e ? ci(r) : "non-empty string" === e ? "string" == typeof r && "" !== r : typeof r === e)) {
        var i = hi(r);
...
function fi(t, e, n) {
    if (void 0 === n) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires a valid " + yi(e) + " argument, but it was undefined.");
}
 ...
 */ function pi(t, e, n, r) {
    var i = hi(r);
    return new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + yi(n) + " argument to be a " + e + ", but it was: " + i);
}

function di(t, e, n) {
    if (n <= 0) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + yi(e) + " argument to be a positive number, but it was: " + n + ".");
}

/** Converts a number to its english word representation */ function yi(t) {
    switch (t) {
      case 1:
        return "first";
...
/** Helper function to assert Base64 functions are available at runtime. */ function mi() {
 ...
 */ var wi = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        Jr("Blob.fromBase64String", arguments, 1), ni("Blob.fromBase64String", "string", 1, e), 
        mi();
        try {
        ...
        if (Jr("Blob.fromUint8Array", arguments, 1), gi(), !(e instanceof Uint8Array)) throw pi("Blob.fromUint8Array", "Uint8Array", 1, e);
        return new t(tt.fromUint8Array(e));
    }, t.prototype.toBase64 = function() {
        return Jr("Blob.toBase64", arguments, 0), mi(), this.Rc.toBase64();
    }, t.prototype.toUint8Array = function() {
        return Jr("Blob.toUint8Array", arguments, 0), gi(), this.Rc.toUint8Array();
    }, t.prototype.toString = function() {
    ...
    !function(t, e, n, r) {
        if (!(e instanceof Array) || e.length < 1) throw new F$1(M$1.INVALID_ARGUMENT, "Function FieldPath() requires its fieldNames argument to be an array with at least " + vi(1, "element") + ".");
    }(0, t);
    for (var e = 0; e < t.length; ++e) if (ni("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Ac = new W$1(t);
}, Ei = /** @class */ function(e) {
    /**
    ...
    return __extends(n, e), n.documentId = function() {
         ...
         * effect is the same.
         */
        return new n(W$1.M().N());
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw pi("isEqual", "FieldPath", 1, t);
        return this.Ac.isEqual(t.Ac);
    }, n;
}(bi), Ii = new RegExp("[~\\*/\\[\\]]"), Ni = function() {
...
var ki = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Vc = t, n;
    }
    return __extends(n, e), n.prototype.yc = function(t) {
        return new qe(t.path, new Re);
    }, n.prototype.isEqual = function(t) {
        return t instanceof n;
    }, n;
}(Ni), Ri = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
...
}(Ni), _i = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Vc = t, r.Cc = n, r;
    }
    return __extends(n, e), n.prototype.yc = function(t) {
        var e = new Le(t.serializer, re(t.serializer, this.Cc));
    ...
    return __extends(n, e), n.delete = function() {
        return Zr("FieldValue.delete", arguments), new Si(new Ai("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Zr("FieldValue.serverTimestamp", arguments), new Si(new ki("FieldValue.serverTimestamp"));
    }, n.arrayUnion = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return ti("FieldValue.arrayUnion", arguments, 1), new Si(new Ri("FieldValue.arrayUnion", t));
    }, n.arrayRemove = function() {
        for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
                return ti("FieldValue.arrayRemove", arguments, 1), new Si(new Di("FieldValue.arrayRemove", t));
    }, n.increment = function(t) {
        return ni("FieldValue.increment", "number", 1, t), Jr("FieldValue.increment", arguments, 1), 
        new Si(new _i("FieldValue.increment", t));
    }, n;
}(Ni), Si = /** @class */ function(e) {
    function n(t) {
        var n = this;
...
}(Vi), Li = /** @class */ function() {
    function t(t, e) {
        if (Jr("GeoPoint", arguments, 2), ni("GeoPoint", "number", 1, t), ni("GeoPoint", "number", 2, e), 
    ...
    return t.prototype.Oc = function(t, e) {
        var n = [];
        return null !== this.qe ? n.push(new Qe(t, this.data, this.qe, e)) : n.push(new $e(t, this.data, e)), 
    ...
    return t.prototype.Oc = function(t, e) {
        var n = [ new Qe(t, this.data, this.qe, e) ];
...
/** A "context" object passed around while parsing user data. */ var Mi = /** @class */ function() {
    ...
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        if (Ci(this.pc) && Pi.test(t)) throw this.gc('Document fields cannot begin and end with "__"');
    }, t;
}(), Fi = /** @class */ function() {
    function t(t, e, n) {
 ...
 * classes.
 */
/** Parse document data from a set() call. */ function xi(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    ...
    if (o.merge) u = new Ue(s.qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var p = l[f], d = void 0;
            if (p instanceof bi) d = p.Ac; else {
    ...
    return new Ui(new tn(c), u, a);
}

/** Parse update data from an update() call. */ function ji(t, e, n, r) {
    var i = t.Qc(1 /* Update */ , e, n);
    Qi("Data must be an object, but it was:", i, r);
    var o = [], s = new en;
    U$1(r, (function(t, r) {
        var u = Hi(e, t, n), a = i.Uc(u);
        if (r instanceof Ni && r.Pc instanceof Ai) 
    ...
    var u = new Ue(o);
    return new qi(s.ze(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Gi(t, e, n, r, i, o) {
    var s = t.Qc(1 /* Update */ , e, n), u = [ Xi(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(Xi(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new en, l = u.length - 1; l >= 0; --l) if (!Ki(h, u[l])) {
        var p = u[l], d = a[l], y = s.Uc(p);
        if (d instanceof Ni && d.Pc instanceof Ai) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var v = zi(d, y);
    ...
    var g = new Ue(h);
    return new qi(f.ze(), g, s.fieldTransforms);
}
 ...
 */ function Bi(t, e, n, r) {
    return void 0 === r && (r = !1), zi(n, t.Qc(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function zi(t, e) {
    if ($i(t)) return Qi("Unsupported field value:", e, t), Wi(t, e);
    if (t instanceof Ni) 
    ...
    return function(t, e) {
        ...
        if (!Ci(e.pc)) throw e.gc(t.Vc + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        throw e.gc("Unsupported field value: " + hi(t));
    }(t, e);
}
...
function $i(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof x$1 || t instanceof Li || t instanceof wi || t instanceof Oi || t instanceof Ni);
}
 ...
 */ function Xi(t, e, n) {
    if (e instanceof bi) return e.Ac;
    if ("string" == typeof e) return Hi(t, e);
 ...
 */ function Hi(t, e, n) {
    try {
        return function(t) {
            if (t.search(Ii) >= 0) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid field path (" + t + "). Paths must not contain '~', '*', '/', '[', or ']'");
            try {
                return new (Ei.bind.apply(Ei, __spreadArrays([ void 0 ], t.split("."))));
            } catch (e) {
 ...
 */ var Zi = /** @class */ function() {
    ...
    return t.prototype.Hc = function(t) {
                ...
                switch (o.label) {
                                    ...
                                    return s = n.sent(), u = new Map, s.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = he(t, e.found.name), r = ue(e.found.updateTime), i = new tn({
                                                    mapValue: {
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof sn || t instanceof on ? i.Jc(t) : T$1();
                    })), r) ];
                }
            }));
        }));
        ...
        this.write([ new Ze(t, this.We(t)) ]), this.zc.add(t.toString());
            ...
            return __generator(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, e) {
                        var n = $.U(e);
                        r.mutations.push(new Je(n, r.We(n)));
    ...
    t.prototype.We = function(t) {
        ...
        return !this.zc.has(t.toString()) && e ? Me.updateTime(e) : Me.Ge();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.Rs = t, this.lo = e, this.updateFunction = n, this.Vs = r, this.Zc = 5, this.ks = new Wn(this.Rs, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.ks.ws((function() {
            return __awaiter(t, void 0, void 0, (function() {
                var t, e, r = this;
                return __generator(this, (function(n) {
                    return t = new Zi(this.lo), (e = this.el(t)) && e.then((function(e) {
                        r.Rs.vs((function() {
        ...
        try {
            ...
            return !Q$1(e) && e.catch && e.then ? e : (this.Vs.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
                    ...
                    return [ 2 /*return*/ , (r.sent(), function(t, r, i) {
                        return __awaiter(this, void 0, void 0, (function() {
                            ...
                            return __generator(this, (function(u) {
                                switch (u.label) {
                                  case 0:
                                    return o = new zn, [ 4 /*yield*/ , t.enqueue((function() {
                                        return __awaiter(s, void 0, void 0, (function() {
                                            ...
                                            return __generator(this, (function(n) {
                                                switch (n.label) {
                                                  ...
                                                  case 1:
                                                    return (t = n.sent()) instanceof on ? o.resolve(t) : t instanceof sn ? o.resolve(null) : o.reject(new F$1(M$1.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                                    [ 3 /*break*/ , 3 ];
                ...
                switch (e.label) {
                  ...
                  case 1:
                    return [ 2 /*return*/ , (e.sent(), function(t, e, n, r) {
                        var i = new zn, o = eo(t, e, hn(n.path), {
                                    ...
                                    return o = new zn, [ 4 /*yield*/ , t.enqueue((function() {
                                        return __awaiter(s, void 0, void 0, (function() {
                                            ...
                                            return __generator(this, (function(n) {
                                                switch (n.label) {
                                                  case 0:
                                                    return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , ur(r, i, 
                                                    /* usePreviousResults= */ !0) ];

                                                  case 1:
                                                    return t = n.sent(), e = new Rr(i, t.Wi), s = e.gh(t.documents), u = e.Ch(s, 
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new zn;
        return this.Rs.vs((function() {
            return new Ji(e.Rs, e.lo, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var no = /** @class */ function() {
    ...
    return t.prototype.ml = function(t) {
        ...
        return new Li(zt(t.latitude), zt(t.longitude));
    }, t.prototype.Al = function(t) {
        var e = this;
        ...
        var e = B.$(t);
        k$1(Ie(e));
        var n = new P$1(e.get(1), e.get(3)), r = new $(e.p(5));
...
}(), ro = Kn.ni, io = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new F$1(M$1.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else ii("settings", "non-empty string", "host", t.host), this.host = t.host, oi("settings", "boolean", "ssl", t.ssl), 
        ...
        oi("settings", "object", "credentials", t.credentials), this.credentials = t.credentials, 
        oi("settings", "boolean", "timestampsInSnapshots", t.timestampsInSnapshots), oi("settings", "boolean", "ignoreUndefinedProperties", t.ignoreUndefinedProperties), 
        ...
        oi("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Kn.ii; else {
            if (t.cacheSizeBytes !== ro && t.cacheSizeBytes < Kn.si) throw new F$1(M$1.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + Kn.si);
            this.cacheSizeBytes = t.cacheSizeBytes;
        }
        oi("settings", "boolean", "experimentalForceLongPolling", t.experimentalForceLongPolling), 
    ...
    function t(r, i, o, s) {
        var u = this;
        if (void 0 === o && (o = new Xr), void 0 === s && (s = new Hr), this.Vl = o, this.yl = s, 
        this.pl = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.gl = new Hn, this.INTERNAL = {
            delete: function() {
                return __awaiter(u, void 0, void 0, (function() {
                    return __generator(this, (function(t) {
                        switch (t.label) {
            ...
            var a = r;
            this.pl = a, this.Nc = t.Sl(a), this.Cl = a.name, this.Dl = new dr(i);
        } else {
            var c = r;
            ...
            this.Cl = "[DEFAULT]", this.Dl = new pr;
        }
        this.Fl = new io({});
    }
    return Object.defineProperty(t.prototype, "Nl", {
        get: function() {
            ...
            this.$l = new Fi(this.Nc, this.Fl.ignoreUndefinedProperties)), this.$l;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.settings = function(t) {
        Jr("Firestore.settings", arguments, 1), ni("Firestore.settings", "object", 1, t), 
        t.merge && 
        ...
        return __awaiter(this, void 0, void 0, (function() {
            ...
            return __generator(this, (function(i) {
                ...
                return t = new zn, [ 2 /*return*/ , (this.gl.Ls((function() {
                    return __awaiter(r, void 0, void 0, (function() {
                        var e;
                        return __generator(this, (function(n) {
                            switch (n.label) {
        ...
        return new L$1(this.Nc, this.Cl, this.Fl.host, this.Fl.ssl, this.Fl.experimentalForceLongPolling);
    }, t.prototype.Ol = function(t, e, n) {
        var r = this.Ml();
        return this.bl = new to(this.Dl, this.gl), this.bl.start(r, t, e, n);
    }, t.Sl = function(t) {
 ...
 */        if (!n || "string" != typeof n) throw new F$1(M$1.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return Jr("Firestore.collection", arguments, 1), ni("Firestore.collection", "non-empty string", 1, t), 
        this.vl(), new Eo(B.$(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return Jr("Firestore.doc", arguments, 1), ni("Firestore.doc", "non-empty string", 1, t), 
        this.vl(), ao.ql(B.$(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (Jr("Firestore.collectionGroup", arguments, 1), ni("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.vl(), new wo(function(t) {
            return new cn(B.k(), t);
        }(t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return Jr("Firestore.runTransaction", arguments, 1), ni("Firestore.runTransaction", "function", 1, t), 
        this.vl().transaction((function(n) {
            return t(new so(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.vl(), new uo(this);
        ...
        var e;
        Jr("Firestore.setLogLevel", arguments, 1), ui("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
    ...
    return t.prototype.get = function(t) {
        ...
        var n = To("Transaction.get", t, this.Wl);
        return this.Ql.Hc([ n.$c ]).then((function(t) {
            if (!t || 1 !== t.length) return T$1();
            var r = t[0];
            if (r instanceof sn) return new ho(e.Wl, n.$c, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.kc);
            if (r instanceof on) return new ho(e.Wl, n.$c, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.kc);
            throw T$1();
        }));
    }, t.prototype.set = function(t, e, n) {
        ei("Transaction.set", arguments, 2, 3);
        var r = To("Transaction.set", t, this.Wl);
        n = Io("Transaction.set", n);
        var i = Ro(r.kc, e, n), o = xi(this.Wl.Nl, "Transaction.set", r.$c, i, null !== r.kc, n);
        return this.Ql.set(r.$c, o), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return "string" == typeof e || e instanceof Ei ? (ti("Transaction.update", arguments, 3), 
        r = To("Transaction.update", t, this.Wl), i = Gi(this.Wl.Nl, "Transaction.update", r.$c, e, n, o)) : (Jr("Transaction.update", arguments, 2), 
        r = To("Transaction.update", t, this.Wl), i = ji(this.Wl.Nl, "Transaction.update", r.$c, e)), 
        this.Ql.update(r.$c, i), this;
    }, t.prototype.delete = function(t) {
        Jr("Transaction.delete", arguments, 1);
        var e = To("Transaction.delete", t, this.Wl);
    ...
    return t.prototype.set = function(t, e, n) {
        ei("WriteBatch.set", arguments, 2, 3), this.Kl();
        var r = To("WriteBatch.set", t, this.Wl);
        n = Io("WriteBatch.set", n);
        var i = Ro(r.kc, e, n), o = xi(this.Wl.Nl, "WriteBatch.set", r.$c, i, null !== r.kc, n);
        return this.jl = this.jl.concat(o.Oc(r.$c, Me.Ge())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.Kl(), "string" == typeof e || e instanceof Ei ? (ti("WriteBatch.update", arguments, 3), 
        r = To("WriteBatch.update", t, this.Wl), i = Gi(this.Wl.Nl, "WriteBatch.update", r.$c, e, n, o)) : (Jr("WriteBatch.update", arguments, 2), 
        r = To("WriteBatch.update", t, this.Wl), i = ji(this.Wl.Nl, "WriteBatch.update", r.$c, e)), 
        this.jl = this.jl.concat(i.Oc(r.$c, Me.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        Jr("WriteBatch.delete", arguments, 1), this.Kl();
        var e = To("WriteBatch.delete", t, this.Wl);
        return this.jl = this.jl.concat(new Ze(e.$c, Me.Ge())), this;
    }, t.prototype.commit = function() {
        return this.Kl(), this.Gl = !0, this.jl.length > 0 ? this.Wl.vl().write(this.jl) : Promise.resolve();
    }, t.prototype.Kl = function() {
        if (this.Gl) throw new F$1(M$1.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), ao = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
    ...
    return __extends(n, e), n.ql = function(t, e, r) {
        ...
        get: function() {
            return new Eo(this.$c.path.g(), this.firestore, this.kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        if (Jr("DocumentReference.collection", arguments, 1), ni("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new F$1(M$1.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        var e = B.$(t);
        return new Eo(this.$c.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw pi("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.$c.isEqual(t.$c) && this.kc === t.kc;
    }, n.prototype.set = function(t, e) {
        ei("DocumentReference.set", arguments, 1, 2), e = Io("DocumentReference.set", e);
        var n = Ro(this.kc, t, e), r = xi(this.firestore.Nl, "DocumentReference.set", this.$c, n, null !== this.kc, e);
        return this.bl.write(r.Oc(this.$c, Me.Ge()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof Ei ? (ti("DocumentReference.update", arguments, 2), 
        n = Gi(this.firestore.Nl, "DocumentReference.update", this.$c, t, e, r)) : (Jr("DocumentReference.update", arguments, 1), 
        n = ji(this.firestore.Nl, "DocumentReference.update", this.$c, t)), this.bl.write(n.Oc(this.$c, Me.exists(!0)));
    }, n.prototype.delete = function() {
        return Jr("DocumentReference.delete", arguments, 0), this.bl.write([ new Ze(this.$c, Me.Ge()) ]);
    }, n.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        ei("DocumentReference.onSnapshot", arguments, 1, 4);
        var s = {
            includeMetadataChanges: !1
        }, u = 0;
        "object" != typeof i[u] || Yr(i[u]) || (li("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        oi("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++);
        var a = {
        ...
        } else ni("DocumentReference.onSnapshot", "function", u, i[u]), ri("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        ri("DocumentReference.onSnapshot", "function", u + 2, i[u + 2]);
        var h = {
            next: function(t) {
                i[u] && i[u](r.zl(t));
            },
        ...
        return this.bl.listen(hn(this.$c.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        ei("DocumentReference.get", arguments, 0, 1), Ao("DocumentReference.get", t);
        var n = this.firestore.vl();
        return t && "cache" === t.source ? n.ul(this.$c).then((function(t) {
            return new ho(e.firestore, e.$c, t, 
            /*fromCache=*/ !0, t instanceof on && t.Ke, e.kc);
    ...
    n.prototype.zl = function(t) {
        ...
        return new ho(this.firestore, this.$c, e, t.fromCache, t.hasPendingWrites, this.kc);
    }, n;
}(Oi), co = /** @class */ function() {
    function t(t, e) {
    ...
    function t(t, e, n, r, i, o) {
        this.Wl = t, this.$c = e, this.Hl = n, this.Yl = r, this.Jl = i, this.kc = o;
    }
    return t.prototype.data = function(t) {
        var e = this;
        if (ei("DocumentSnapshot.data", arguments, 0, 1), t = No("DocumentSnapshot.data", t), 
        this.Hl) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.kc) {
                var n = new fo(this.Wl, this.$c, this.Hl, this.Yl, this.Jl, 
                /* converter= */ null);
                return this.kc.fromFirestore(n, t);
            }
            return new no(this.Wl.Nc, this.Wl.Ul(), t.serverTimestamps || "none", (function(t) {
                return new ao(t, e.Wl, /* converter= */ null);
            })).ml(this.Hl.tn());
        }
    }, t.prototype.get = function(t, e) {
        var n = this;
        if (ei("DocumentSnapshot.get", arguments, 1, 2), e = No("DocumentSnapshot.get", e), 
        this.Hl) {
            var r = this.Hl.data().field(Xi("DocumentSnapshot.get", t, this.$c));
            if (null !== r) return new no(this.Wl.Nc, this.Wl.Ul(), e.serverTimestamps || "none", (function(t) {
                return new ao(t, n.Wl, n.kc);
            })).ml(r);
        }
        ...
        get: function() {
            return new ao(this.$c, this.Wl, this.kc);
        },
        enumerable: !1,
        configurable: !0
        ...
        get: function() {
            return new co(this.Jl, this.Yl);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw pi("isEqual", "DocumentSnapshot", 1, e);
        return this.Wl === e.Wl && this.Yl === e.Yl && this.$c.isEqual(e.$c) && (null === this.Hl ? null === e.Hl : this.Hl.isEqual(e.Hl)) && this.kc === e.kc;
    }, t;
}(), fo = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
...
function lo(t, e, n, r, i, o, s) {
    ...
    } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || vo(s, o), 
    u = Bi(n, e, s, 
...
function yo(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!fn(e) && -1 !== n.indexOf("/")) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(B.$(n));
        if (!$.j(r)) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return $t(t, new $(r));
    }
    if (n instanceof Oi) return $t(t, n.$c);
    throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + hi(n) + ".");
}
...
var wo = /** @class */ function() {
    ...
    return t.prototype.where = function(e, n, r) {
        ...
        var i;
        Jr("Query.where", arguments, 3), fi("Query.where", 3, r), i = "not-in" === n || "!=" === n ? n : ui("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, n);
        var o = Xi("Query.where", e), s = lo(this.Xl, "Query.where", this.firestore.Nl, this.firestore.Nc, o, i, r);
        return new t(function(t, e) {
            var n = t.filters.concat([ e ]);
            return new cn(t.path, t.collectionGroup, t.en.slice(), n, t.limit, t.nn, t.startAt, t.endAt);
        }(this.Xl, s), this.firestore, this.kc);
    }, t.prototype.orderBy = function(e, n) {
        var r;
        if (ei("Query.orderBy", arguments, 1, 2), ri("Query.orderBy", "non-empty string", 2, n), 
        ...
        var i = Xi("Query.orderBy", e), o = po(this.Xl, i, r);
        return new t(function(t, e) {
            // TODO(dimond): validate that orderBy does not list the same key twice.
            var n = t.en.concat([ e ]);
            return new cn(t.path, t.collectionGroup, n, t.filters.slice(), t.limit, t.nn, t.startAt, t.endAt);
        }(this.Xl, o), this.firestore, this.kc);
    }, t.prototype.limit = function(e) {
        return Jr("Query.limit", arguments, 1), ni("Query.limit", "number", 1, e), di("Query.limit", 1, e), 
        new t(dn(this.Xl, e, "F" /* First */), this.firestore, this.kc);
    }, t.prototype.limitToLast = function(e) {
        return Jr("Query.limitToLast", arguments, 1), ni("Query.limitToLast", "number", 1, e), 
        di("Query.limitToLast", 1, e), new t(dn(this.Xl, e, "L" /* Last */), this.firestore, this.kc);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        ti("Query.startAt", arguments, 1);
        var i = this.Zl("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(yn(this.Xl, i), this.firestore, this.kc);
    }, t.prototype.startAfter = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        ti("Query.startAfter", arguments, 1);
        var i = this.Zl("Query.startAfter", e, n, 
        /*before=*/ !1);
        return new t(yn(this.Xl, i), this.firestore, this.kc);
    }, t.prototype.endBefore = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        ti("Query.endBefore", arguments, 1);
        var i = this.Zl("Query.endBefore", e, n, 
        /*before=*/ !0);
        return new t(vn(this.Xl, i), this.firestore, this.kc);
    }, t.prototype.endAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        ti("Query.endAt", arguments, 1);
        var i = this.Zl("Query.endAt", e, n, 
        /*before=*/ !1);
        return new t(vn(this.Xl, i), this.firestore, this.kc);
    }, t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw pi("isEqual", "Query", 1, e);
        return this.firestore === e.firestore && gn(this.Xl, e.Xl) && this.kc === e.kc;
    }, t.prototype.withConverter = function(e) {
        return new t(this.Xl, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.Zl = function(t, e, n, i) {
        if (fi(t, 1, e), e instanceof ho) return Jr(t, __spreadArrays([ e ], n), 1), function(t, e, n, r, i) {
            ...
            for (var o = [], s = 0, u = ln(t); s < u.length; s++) {
                var a = u[s];
                if (a.field.L()) o.push($t(e, r.key)); else {
            ...
            return new Sn(o, i);
        }(this.Xl, this.firestore.Nc, t, e.Hl, i);
        var o = [ e ].concat(n);
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.L()) {
                    ...
                    if (!fn(t) && -1 !== c.indexOf("/")) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(B.$(c));
                    if (!$.j(h)) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                    var f = new $(h);
                    u.push($t(e, f));
                } else {
                    var l = Bi(n, r, c);
            ...
            return new Sn(u, o);
        }(this.Xl, this.firestore.Nc, this.firestore.Nl, t, o, i);
    }, t.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        ei("Query.onSnapshot", arguments, 1, 4);
        var s = {}, u = 0;
        if ("object" != typeof i[u] || Yr(i[u]) || (li("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        oi("Query.onSnapshot", "boolean", "includeMetadataChanges", s.includeMetadataChanges), 
        u++), Yr(i[u])) {
            var a = i[u];
        ...
        } else ni("Query.onSnapshot", "function", u, i[u]), ri("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        ri("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new bo(r.firestore, r.Xl, t, r.kc));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return mo(this.Xl), this.firestore.vl().listen(this.Xl, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        ei("Query.get", arguments, 0, 1), Ao("Query.get", t), mo(this.Xl);
        var n = this.firestore.vl();
        return (t && "cache" === t.source ? n.ll(this.Xl) : n._l(this.Xl, t)).then((function(t) {
            return new bo(e.firestore, e.Xl, t, e.kc);
        }));
    }, t;
}(), bo = /** @class */ function() {
    function t(t, e, n, r) {
        this.Wl = t, this.t_ = e, this.e_ = n, this.kc = r, this.n_ = null, this.s_ = null, 
        this.metadata = new co(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        ei("QuerySnapshot.forEach", arguments, 1, 2), ni("QuerySnapshot.forEach", "function", 1, t), 
        this.e_.docs.forEach((function(r) {
            t.call(e, n.i_(r, n.metadata.fromCache, n.e_.qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new wo(this.t_, this.Wl, this.kc);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (li("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), oi("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.e_.Bt) throw new F$1(M$1.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw pi("isEqual", "QuerySnapshot", 1, e);
        return this.Wl === e.Wl && gn(this.t_, e.t_) && this.e_.isEqual(e.e_) && this.kc === e.kc;
    }, t.prototype.i_ = function(t, e, n) {
        return new fo(this.Wl, t.key, t, e, n, this.kc);
    }, t;
}(), Eo = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, hn(t), n, r) || this).r_ = t, t.length % 2 != 1) throw new F$1(M$1.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.N() + " has " + t.length);
        return i;
    }
    return __extends(n, e), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            var t = this.Xl.path.g();
            return t._() ? null : new ao(new $(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        ei("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = _.t()), ni("CollectionReference.doc", "non-empty string", 1, t);
        var e = B.$(t);
        return ao.ql(this.Xl.path.child(e), this.firestore, this.kc);
    }, n.prototype.add = function(t) {
        Jr("CollectionReference.add", arguments, 1), ni("CollectionReference.add", "object", 1, this.kc ? this.kc.toFirestore(t) : t);
        var e = this.doc();
        return e.set(t).then((function() {
            return e;
        }));
    }, n.prototype.withConverter = function(t) {
        return new n(this.r_, this.firestore, t);
    }, n;
}(wo);
...
function Io(t, e) {
    ...
    if (li(t, e, [ "merge", "mergeFields" ]), oi(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
            if (!(r instanceof Array)) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires its " + e + " option to be an array, but it was: " + hi(r));
            for (var o = 0; o < r.length; ++o) if (!i(r[o])) throw new F$1(M$1.INVALID_ARGUMENT, "Function " + t + "() requires all " + e + " elements to be " + n + ", but the value at index " + o + " was: " + hi(r[o]));
        }(t, e, n, r, i);
...
function No(t, e) {
    return void 0 === e ? {} : (li(t, e, [ "serverTimestamps" ]), si(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Ao(t, e) {
    ri(t, "object", 1, e), e && (li(t, e, [ "source" ]), si(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
var Do = {
    ...
    FieldPath: Ei,
    FieldValue: Vi,
    setLogLevel: oo.setLogLevel,
    CACHE_SIZE_UNLIMITED: ro
};
 ...
 */ function _o(t) {
    !function(t, e) {
        t.INTERNAL.registerComponent(new Component("firestore", (function(t) {
            return function(t, e) {
                return new oo(t, e, new Xr, new Hr);
            }(t.getProvider("app").getImmediate(), t.getProvider("auth-internal"));
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Do)));
    }(t), t.registerVersion("@firebase/firestore", "1.16.6");
}

_o(i__default['default']);
