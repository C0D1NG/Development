...
var SyncEngineImpl = /** @class */ (function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [3 /*break*/, 4];
                    case 1: return [4 /*yield*/, allocateTarget(this.localStore, queryToTarget(query))];
                    case 2:
                        targetData = _e.sent();
    ...
    SyncEngineImpl.prototype.initializeViewAndComputeSnapshot = function (query, targetId, current) {
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0: return [4 /*yield*/, executeQuery(this.localStore, query, 
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, releaseTarget(this.localStore, queryView.targetId, 
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 5, , 6]);
                        return [4 /*yield*/, localWrite(this.localStore, batch)];
                    case 2:
                        result = _e.sent();
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 4, , 6]);
                        return [4 /*yield*/, applyRemoteEventToLocalCache(this.localStore, remoteEvent)];
                    case 2:
                        changes = _e.sent();
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, releaseTarget(this.localStore, targetId, 
                        /* keepPersistedTargetData */ false)
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 4, , 6]);
                        return [4 /*yield*/, acknowledgeBatch(this.localStore, mutationBatchResult)];
                    case 2:
                        changes = _e.sent();
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 4, , 6]);
                        return [4 /*yield*/, rejectBatch(this.localStore, batchId)];
                    case 2:
                        changes = _e.sent();
                        // The local store may or may not be able to apply the write result and
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _e.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, getHighestUnacknowledgedBatchId(this.localStore)];
                    case 2:
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        this.queryViewsByQuery.forEach(function (_, queryView) {
                            queriesProcessed.push(Promise.resolve()
                                ...
                                return executeQuery(_this.localStore, queryView.query, 
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, notifyLocalViewChanges(this.localStore, docChangesInAllViews)];
                    case 2:
                        _e.sent();
                        return [2 /*return*/];
                }
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, handleUserChange(this.localStore, user)];
                    case 1:
                        result = _e.sent();
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 7:
                        ...
                        return [4 /*yield*/, getLastRemoteSnapshotVersion(this.localStore)];
                    case 8:
                ...
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        if (!op) {
                            ...
                            op = function () { return getLastRemoteSnapshotVersion(_this.localStore); };
                        }
        ...
        return tslib.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib.__generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 2:
                        _e.trys.push([2, 4, , 6]);
                        return [4 /*yield*/, nextMutationBatch(this.localStore, lastBatchIdRetrieved)];
                    case 3:
                        batch = _e.sent();
                        if (batch === null) {
                            if (this.writePipeline.length === 0) {
