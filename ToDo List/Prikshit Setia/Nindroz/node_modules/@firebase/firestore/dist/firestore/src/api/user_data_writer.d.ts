...
export declare class UserDataWriter {
    ...
    constructor(databaseId: DatabaseId, timestampsInSnapshots: boolean, serverTimestampBehavior: ServerTimestampBehavior, referenceFactory: (key: DocumentKey) => DocumentKeyReference<DocumentData>);
