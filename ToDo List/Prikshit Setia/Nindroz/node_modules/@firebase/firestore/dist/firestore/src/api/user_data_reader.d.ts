...
import { BaseFieldPath } from './field_path';
/**
...
export declare function parseUpdateVarargs(userDataReader: UserDataReader, methodName: string, targetDoc: DocumentKey, field: string | BaseFieldPath, value: unknown, moreFieldsAndValues: unknown[]): ParsedUpdateData;
/**
 ...
 */
export declare function fieldPathFromArgument(methodName: string, path: string | BaseFieldPath, targetDoc?: DocumentKey): FieldPath;
/**
