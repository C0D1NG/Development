...
export declare function enqueueWrite(asyncQueue: AsyncQueue, syncEngine: SyncEngine, mutations: Mutation[]): Promise<void>;
export declare function enqueueNetworkEnabled(asyncQueue: AsyncQueue, remoteStore: RemoteStore, persistence: Persistence, enabled: boolean): Promise<void>;
export declare function enqueueWaitForPendingWrites(asyncQueue: AsyncQueue, syncEngine: SyncEngine): Promise<void>;
export declare function enqueueListen(asyncQueue: AsyncQueue, eventManger: EventManager, query: Query, options: ListenOptions, observer: PartialObserver<ViewSnapshot>): Unsubscribe;
export declare function enqueueSnapshotsInSyncListen(asyncQueue: AsyncQueue, eventManager: EventManager, observer: PartialObserver<void>): Unsubscribe;
export declare function enqueueReadDocumentFromCache(asyncQueue: AsyncQueue, localStore: LocalStore, docKey: DocumentKey): Promise<Document | null>;
/**
 * Retrieves a latency-compensated document from the backend via a
 * SnapshotListener.
 */
export declare function enqueueReadDocumentViaSnapshotListener(asyncQueue: AsyncQueue, eventManager: EventManager, key: DocumentKey, options?: GetOptions): Promise<ViewSnapshot>;
export declare function enqueueExecuteQueryFromCache(asyncQueue: AsyncQueue, localStore: LocalStore, query: Query): Promise<ViewSnapshot>;
/**
 * Retrieves a latency-compensated query snapshot from the backend via a
 * SnapshotListener.
 */
export declare function enqueueExecuteQueryViaSnapshotListener(asyncQueue: AsyncQueue, eventManager: EventManager, query: Query, options?: GetOptions): Promise<ViewSnapshot>;
